#THIS SCRIPT GENERATES ROC CURVES AND STAT RESULTS FOR 500 DAY TIMESERIES AT BF = 400 
#SCRIPT RAN ON COMPUTE CANDA, BELUGA
...
registerDoParallel(numCores) #Registering it so the cluster uses all cores
...
class_ts_path <- "/home/mhkent/scratch/predict data/400" 
...
write.csv(det_forh, paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/station_info/", common_stats[i], "_all_info.csv", sep = ""))
...
write.csv(stat_tab, paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/station_stats/", common_stats[i], "_station_stats.csv", sep = ""))
...
write.csv(stat_tab_wh, paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/total_station_stats.csv", sep = ""))
...
sink(paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/ROC_WITH_HOPH_STATS.txt", sep = ""))
...
pdf(paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/ROC_WITH_HOPH.pdf", sep = ""))
...
write.csv(stat_tab_wo, paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m],"/total_station_stats_with_hoph.csv", sep = ""))
...
sink(paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/#ROC_WITHOUT_HOPH_STATS.txt", sep = ""))               
#print(class_thr_list[m])
...
pdf(paste("/home/mhkent/scratch/Bif_400/", class_thr_list[m], "/ROC_WITHOUT_HOPH.pdf", sep = ""))
...
#Running the ooga booga function in parallell
